...
public class Attendance
{
    ...
    public Attendance(string id, int numberOfAttendances, int maxAttendanceDays, DateTime lastAttendanceTime)
    {
    ...
    {
        if (LastAttendanceTime.Date == now.Date)
        {
            return;
        }

        if ((now.Date - LastAttendanceTime.Date).Days == 1)
        {
            ConsecutiveDays += 1;
        }
        else
